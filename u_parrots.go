	...
	case HelloChrome_153:
		return ClientHelloSpec{
			...
			Extensions: ShuffleChromeTLSExtensions([]TLSExtension{
				...
				&ApplicationSettingsExtensionNew{SupportedProtocols: []string{"h2"}},
				// Chrome sends an empty RequestedTrustAnchorList when the
				// trust-anchor-IDs feature is enabled but no IDs are requested.
				&GenericExtension{Id: utlsExtensionTrustAnchors, Data: []byte{0, 0}},
				BoringGREASEECH(),
				&UtlsGREASEExtension{},
			}),
		}, nil
